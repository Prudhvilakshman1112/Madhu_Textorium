                        ...
                        <div className={styles.addOnBody}>
                          ...
                          <div className={styles.measureFields}>
                            {[
                              ...
                              { key: 'rise' as keyof Measurements, label: 'Rise / Kirtha', placeholder: '11', hint: 'Full length from front waistband center down through crotch to back waistband center' },
                            ].map(f => (
